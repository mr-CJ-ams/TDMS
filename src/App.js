...
const App = () => {
  ...
  useEffect(() => {
    $(dateRangeRef.current).daterangepicker({
      ...
      setDateRange({ startDate: start.format('YYYY-MM-DD'), endDate: end.format('YYYY-MM-DD') });
    });
  }, []);
          ...
          <div className="task card mb-2" key={guest.id}>
            <div className="card-body">
              <p className="card-text">
                ...
                Age: {guest.age}, Citizenship: {guest.citizenship} <br />
                Date Range: {guest.dateRange.startDate} to {guest.dateRange.endDate}
              </p>
